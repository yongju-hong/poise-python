      ...
      def system_package_candidates(version)
        [].tap do |names|
          ...
          if version == '3' || version == ''
            names.concat(%w{python3.10 python310 python3.8 python38 python3.7 python37 python3.6 python36 python3.5 python35 python3.4 python34 python3.3 python33 python3.2 python32 python3.1 python31 python3.0 python30 python3})
          end
